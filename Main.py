...
def static_allocation_DeBruijn(method, net, items, frequency_of_items):
    if method == "greedy":
        ...
        cost = Allocation.arash_prop_Tree_algorithm(net, items, frequency_of_items)
...
# ------ options for method = {"greedy, "Arash", "Fractional", "Prop-Arash"}
cost_of_static = static_allocation_DeBruijn("Prop-Arash", network, list_items, frequencies)
